        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.mukims.update', $mukim) }}" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <input type="text" name="mukim_no" id="mukim_no"
                                value="{{ old('mukim_no', $mukim->mukim_no) }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="short_mukim" id="short_mukim"
                                value="{{ old('short_mukim', $mukim->short_mukim) }}"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                            ...
                            <div class="mt-2">
                                <label class="inline-flex items-center">
                                    <input type="checkbox" name="status" value="1"
                                        {{ old('status', $mukim->status) ? 'checked' : '' }}
