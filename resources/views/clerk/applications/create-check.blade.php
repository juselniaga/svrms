            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                @if(isset($developers) && $developers->isNotEmpty())
                    ...
                    <p class="text-sm text-gray-500 mb-6">We found {{ $developers->count() }} matching developer(s). Please
                        select the correct one or register a new one.</p>
                    ...
                    <div class="flex items-center justify-between border-t pt-4">
                        ...
                        <form action="{{ route('clerk.developers.create') }}" method="GET" class="inline">
                            ...
                            <button
                                ...
                                Not listed? Register New Developer
                            </button>
                        </form>
                    </div>
                @else
                    <form method="POST" action="{{ route('clerk.applications.check-developer') }}">
                        ...
                        <h3 class="text-lg font-medium text-gray-900 mb-2">Step 1: Verify Developer</h3>
                        <p class="text-sm text-gray-500 mb-6">Please enter the developer's registered name or email address
                            to check
                            if they already exist in the system.</p>
