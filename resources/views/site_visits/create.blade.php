        ...
        <form method="POST" action="{{ route('site-visits.store') }}" enctype="multipart/form-data">
            ...
            <x-card title="Visit Details" class="mb-6">
                <div class="w-full sm:w-1/3">
                    ...
                    <x-text-input id="visit_date" class="block mt-1 w-full" type="date" name="visit_date" :value="old('visit_date', \Carbon\Carbon::now()->format('Y-m-d'))" required />
                    ...
                    <div class="border-b pb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <textarea id="finding_north" name="finding_north" class="block mt-1 w-full bg-surface border-gray-300 focus:border-primary-light focus:ring-primary-light rounded-md shadow-sm" rows="3">{{ old('finding_north') }}</textarea>
                            </div>
                            <div>
                    ...
                    <div class="border-b pb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <textarea id="finding_south" name="finding_south" class="block mt-1 w-full bg-surface border-gray-300 focus:border-primary-light focus:ring-primary-light rounded-md shadow-sm" rows="3">{{ old('finding_south') }}</textarea>
                            </div>
                            <div>
                    ...
                    <div class="border-b pb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <textarea id="finding_east" name="finding_east" class="block mt-1 w-full bg-surface border-gray-300 focus:border-primary-light focus:ring-primary-light rounded-md shadow-sm" rows="3">{{ old('finding_east') }}</textarea>
                            </div>
                            <div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <textarea id="finding_west" name="finding_west" class="block mt-1 w-full bg-surface border-gray-300 focus:border-primary-light focus:ring-primary-light rounded-md shadow-sm" rows="3">{{ old('finding_west') }}</textarea>
                            </div>
                            <div>
            ...
            <x-card title="Site Conditions & Parameters" class="mb-6">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <x-text-input id="activity" class="block mt-1 w-full" type="text" name="activity" :value="old('activity')" />
                    </div>
                    <div>
                        <x-input-label for="land_use_zone" value="Land Use Zone" />
                        <x-text-input id="land_use_zone" class="block mt-1 w-full" type="text" name="land_use_zone" :value="old('land_use_zone')" />
                    </div>
                    <div>
                        <x-input-label for="density" value="Density / Plot Ratio" />
                        <x-text-input id="density" class="block mt-1 w-full" type="text" name="density" :value="old('density')" />
                    </div>
                    <div>
                        <x-input-label for="entrance_way" value="Entrance Access" />
                        <x-text-input id="entrance_way" class="block mt-1 w-full" type="text" name="entrance_way" :value="old('entrance_way')" />
                    </div>
                    <div>
                        <x-input-label for="parit" value="Drainage / Parit" />
                        <x-text-input id="parit" class="block mt-1 w-full" type="text" name="parit" :value="old('parit')" />
                    </div>
                    <div>
                        <x-input-label for="tree" value="Est. Trees Impacted" />
                        <x-text-input id="tree" class="block mt-1 w-full" type="number" min="0" name="tree" :value="old('tree')" />
                    </div>
                </div>
                ...
                <div class="mt-6 border-t pt-4 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <textarea id="location_data" name="location_data" class="block mt-1 w-full bg-surface border-gray-300 focus:border-primary-light focus:ring-primary-light rounded-md shadow-sm" rows="3">{{ old('location_data') }}</textarea>
                    </div>
                </div>
            </x-card>
