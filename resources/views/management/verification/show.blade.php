    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            @if($application->status === 'PENDING_VERIFICATION')
                <div class="bg-white overflow-hidden shadow-lg border border-purple-200 sm:rounded-lg"
                    x-data="{ action: '' }">
                    <div class="p-6">
                        <h3 class="text-lg font-bold border-b pb-2 mb-4 text-purple-900 border-purple-100">Assistant
                            Director Action</h3>

                        <form method="POST" action="{{ route('verification.update', $application->application_id) }}">
                            @csrf
