<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <!-- Task Todo Section -->
            <div class="mb-4">
                <h3 class="text-lg font-medium text-gray-900">Task Todo (Pending Final Approval)</h3>
            </div>
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            @if($app->verification && $app->verification->verification_status === 'VERIFIED')
                                                <span
                                                    class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800 border border-green-200">Verified</span>
                                            @else
                                                <span
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5"
                                            ...
                                            No applications currently pending final approval. Great work!
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
