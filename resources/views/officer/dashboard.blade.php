<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-4">
                <h3 class="text-lg font-medium text-gray-900">Tindakan Diperlukan</h3>
            </div>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            ...
                                            @elseif($app->status === 'SITE_VISIT_IN_PROGRESS')
                                                <a href="{{ route('officer.review.create', $app->application_id) }}"
                                                    class="button text-white bg-green-700 hover:bg-green-600 font-semibold px-4 py-2 rounded shadow-sm inline-block transition">Teruskan
                                                    Semakan</a>
                                            @endif
                                        </td>
                                    </tr>
            ...
            <div class="mt-12 bg-white p-6 shadow-sm rounded-lg border-t-4 border-purple-500">
                <form method="GET" action="{{ route('officer.dashboard') }}"
                    class="flex flex-col sm:flex-row gap-4 mb-2">
                    <div class="flex-1">
                        <label for="search" class="block text-sm font-medium text-gray-700 mb-1">Carian
                            Permohonan</label>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <a href="{{ route('applications.show', $app) }}"
                                                class="text-gray-500 hover:text-gray-700">View Details</a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
