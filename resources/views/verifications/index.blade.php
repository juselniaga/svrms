<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-8">
        ...
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-xl font-display font-semibold text-gray-800">Applications Awaiting Verification</h2>
        </div>
                        ...
                        @forelse ($applications as $app)
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right font-medium">
                                    @if($app->status === 'REVIEW_COMPLETED')
                                        <a href="{{ route('verifications.create', ['application_id' => $app->application_id]) }}" class="text-primary hover:text-primary-light font-semibold">Verify Now</a>
                                    @else
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center text-gray-500">
                                    No applications currently require verification.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
